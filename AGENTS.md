...
- **Planes en documento:** trabajos multi-paso (feature, refactor, fix con varios archivos) se planifican primero en `.opencode/plans/<nombre>.md` (resumen del cambio, archivos a crear/modificar, reglas de negocio y verificación). El usuario revisa y aprueba el plan antes de tocar código; al aprobar, se ejecuta tal cual quedó documentado.
